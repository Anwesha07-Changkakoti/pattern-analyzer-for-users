...
import HeatmapChart from "./HeatmapChart"; // 🚀 NEW
...
export default function App() {
  ...
  const [fileId,    setFileId]    = useState(null);   // ⬅ used by Heatmap
  ...
  const onUpload = async (e) => {
    ...
    try {
      ...
      setFileId(data.file_id);          // 📌 store for heat‑map & download
      setBatchRows([]);
    } catch (err) {
      console.error(err);
