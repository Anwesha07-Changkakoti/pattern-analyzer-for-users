      ...
      <div className="space-x-4">
        ...
        {user && (
          <>
            ...
            <Link to="/admin" className="hover:underline text-red-400 font-semibold">
                Admin Dashboard
              </Link>
              <Link to="/all-behaviors" className="hover:underline text-red-400 font-semibold">All users</Link>
          </>
