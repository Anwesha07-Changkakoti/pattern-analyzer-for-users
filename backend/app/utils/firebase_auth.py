...
async def get_current_user_optional(request: Request) -> Optional[Dict]:
    ...
    print("🧾 Received Auth Header:", auth_header)  # Add this line
...
async def verify_firebase_token(token: str) -> Optional[Dict]:
    try:
        ...
        print("✅ Firebase token verified:", decoded_token)
        return {
        ...
        print("🔥 Firebase token verification failed:", e)  # 👈 this will show the actual reason
        return None
